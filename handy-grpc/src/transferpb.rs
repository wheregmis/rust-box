        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn transfer(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/transferpb.DataTransfer/Transfer",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("transferpb.DataTransfer", "Transfer"));
        ...
        pub async fn send(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/transferpb.DataTransfer/Send",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("transferpb.DataTransfer", "Send"));
...
pub mod data_transfer_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/transferpb.DataTransfer/Transfer" => {
                    ...
                    struct TransferSvc<T: DataTransfer>(pub Arc<T>);
                    impl<
                        T: DataTransfer,
                    ...
                    for TransferSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DataTransfer>::transfer(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/transferpb.DataTransfer/Send" => {
                    #[allow(non_camel_case_types)]
                    struct SendSvc<T: DataTransfer>(pub Arc<T>);
                    impl<T: DataTransfer> tonic::server::UnaryService<super::Message>
                    for SendSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataTransfer>::send(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "transferpb.DataTransfer";
